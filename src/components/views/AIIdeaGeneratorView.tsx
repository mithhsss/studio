                ...
                return (
                    <div className="animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            <div><label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1"><Zap size={14} /> Core Subject</label><Input placeholder="e.g., A new feature for our mobile app" type="text" value={formData.subject} onChange={(e) => setIdeaFormData({ ...formData, subject: e.target.value })} /></div>
                            <div><label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1"><Users size={14} /> Target Audience</label><Input placeholder="e.g., Power users and new customers" type="text" value={formData.audience} onChange={(e) => setIdeaFormData({ ...formData, audience: e.target.value })} /></div>
                            <div><label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1"><Box size={14} /> Key Constraints</label><Input placeholder="e.g., Budget under $10k, must be virtual" type="text" value={formData.constraints} onChange={(e) => setIdeaFormData({ ...formData, constraints: e.target.value })} /></div>
                            <div><label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1"><PlusSquare size={14} /> Other Criteria</label><Input placeholder="e.g., Focus on wellness, encourage collaboration" type="text" value={formData.other} onChange={(e) => setIdeaFormData({ ...formData, other: e.target.value })} /></div>
